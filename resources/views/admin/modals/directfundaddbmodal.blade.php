<div class="modal fade text-left" id="directaddfundb" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              ...
                              <form method="post" action="{{route('admin-add-money-bonus')}}">
                                @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="sponsor3" name="user_id"   class="form-control" placeholder="Enter User Name" required/>
                            <div id="suggestUser3"></div>
                        </div>
                        <div class="mb-3">
