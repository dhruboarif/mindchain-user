<div class="modal fade text-left" id="directaddfundt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              ...
                              <form method="post" action="{{route('admin-add-money-token')}}">
                                @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="sponsor2" name="user_id"   class="form-control" placeholder="Enter User Name" required/>
