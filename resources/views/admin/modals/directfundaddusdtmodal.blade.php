<div class="modal fade text-left" id="directaddusdt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              ...
                              <div class="card-body">
                              <form method="post" action="{{route('admin-add-money-usdt')}}">
                                @csrf
