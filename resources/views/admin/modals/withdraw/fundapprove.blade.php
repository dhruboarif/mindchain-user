<div class="modal fade text-left" id="withdrawApproveconfirm{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              ...
                              <form method="post" action="{{route('withdraw-bonus-approve')}}">
                                @csrf
