<div class="modal fade text-left" id="musdWithdrawApprove{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              ...
                              <form method="post" action="{{route('musd-withdraw-approve')}}">
                                @csrf
