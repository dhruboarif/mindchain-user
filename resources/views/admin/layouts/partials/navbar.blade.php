      ...
      <ul class="navbar-nav ms-auto navbar-list mb-2 mb-lg-0 align-items-center">
              ...
              <div class="card shadow-none m-0">
                ...
                <div class="card-body p-0">
                    <a href="#" class="iq-sub-card">
                      <div class="d-flex">
                          <img src="{{asset('assets/images/utilities/05.png')}}" class="img-fluid avatar avatar-30 avatar-rounded" alt="img51"><div class="ms-3 w-100">
                    ...
                    <a href="#" class="iq-sub-card">
                      <div class="d-flex align-items-center">
                          <div class="">
                            <img src="{{asset('assets/images/utilities/03.png')}}" class="img-fluid avatar avatar-30 avatar-rounded" alt="img52">
                          </div>
                    ...
                    <a href="#" class="iq-sub-card">
                      <div class="d-flex align-items-center">
                          <img src="{{asset('assets/images/utilities/04.png')}}" class="img-fluid avatar avatar-30 avatar-rounded" alt="img53"><div class="ms-3 w-100">
                    ...
                    <a href="#" class="iq-sub-card">
                      <div class="d-flex align-items-center">
                          <img src="{{asset('assets/images/utilities/05.png')}}" class="img-fluid avatar avatar-30 avatar-rounded" alt="img54"><div class="w-100 ms-3">
              ...
              <div class="card shadow-none m-0">
                ...
                <div class="card-body p-0 ">
                    <a href="#" class="iq-sub-card">
                      <div class="d-flex ">
                          <div class="">
                            <img src="{{asset('assets/images/coins/02.png')}}" class="img-fluid avatar avatar-50 avatar-rounded" alt="img55">
                          </div>
                    ...
                    <a href="#" class="iq-sub-card">
                      <div class="d-flex">
                          <div class="">
                            <img src="{{asset('assets/images/coins/03.png')}}" class="img-fluid avatar avatar-50 avatar-rounded" alt="img56">
                          </div>
                          <div class="ms-3">
                    ...
                    <a href="#" class="iq-sub-card">
                      <div class="d-flex">
                          <div class="">
                            <img src="{{asset('assets/images/coins/06.png')}}" class="img-fluid avatar avatar-50 avatar-rounded" alt="img57">
                          </div>
                          <div class="ms-3">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            @else
            <img src="{{asset('storage/User/'.Auth::user()->image)}}" alt="User-Profile" class="img-fluid avatar avatar-50 avatar-rounded">
