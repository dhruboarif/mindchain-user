    ...
    <div class="sidebar-body p-0 data-scrollbar">
        <div class="collapse navbar-collapse pe-3" id="sidebar">
            <ul class="navbar-nav iq-main-menu">
                ...
                <!--<li class="nav-item ">-->
                <!--    <a class="nav-link active" aria-current="page" href="{{route('admin.compose.email')}}">-->
                <!--        <i class="icon">-->
                <!--                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                    <path d="M9.15722 20.7714V17.7047C9.1572 16.9246 9.79312 16.2908 10.581 16.2856H13.4671C14.2587 16.2856 14.9005 16.9209 14.9005 17.7047V17.7047V20.7809C14.9003 21.4432 15.4343 21.9845 16.103 22H18.0271C19.9451 22 21.5 20.4607 21.5 18.5618V18.5618V9.83784C21.4898 9.09083 21.1355 8.38935 20.538 7.93303L13.9577 2.6853C12.8049 1.77157 11.1662 1.77157 10.0134 2.6853L3.46203 7.94256C2.86226 8.39702 2.50739 9.09967 2.5 9.84736V18.5618C2.5 20.4607 4.05488 22 5.97291 22H7.89696C8.58235 22 9.13797 21.4499 9.13797 20.7714V20.7714" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>                                </svg>-->
                <!--        </i>-->
                <!--        <span class="item-name">Send email to user</span>-->
                <!--    </a>-->
                <!--</li>-->
                 ...
                 <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-ct" role="button" aria-expanded="false" aria-controls="sidebar-user">
                        <i class="icon">
                        ...
                        <span class="item-name">Community Token</span>
                        <i class="right-icon">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-ct" data-bs-parent="#sidebar">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('baseMindStageList') }}">
                                <i class="icon">
                                ...
                                <span class="item-name">BaseMind(B-MIND)</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('baseMindPacakgeSettings') }}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                                ...
                                <i class="sidenav-mini-icon"> A </i>
                                <span class="item-name">BaseMind(Package Settings)</span>
                            </a>
                        </li>
                        
                         <li class="nav-item">
                            <a class="nav-link" href="{{route('admin-target-lists')}}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                                ...
                                <span class="item-name">Bmind User Target Settings</span>
                            </a>
                        </li>
                        <!--<li class="nav-item">-->
                        ...
                        <!--        </i>-->
                        <!--        <i class="sidenav-mini-icon"> A </i>-->
                        <!--        <span class="item-name">PerryMind (P-MIND)</span>-->
                        <!--    </a>-->
                        <!--</li>-->
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-network" data-bs-parent="#sidebar">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('admin-ambassador-lists')}}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Ambassador List</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('admin-merchant-lists')}}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Merchant List</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('admin-consultant-lists')}}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Consultant List</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('admin-elite-member-lists')}}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Elite Member List</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                ...
                <li class="nav-item">
                   <a class="nav-link " href="{{route('kyc-verification')}}">
                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                       <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                     </svg>
                       <i class="sidenav-mini-icon"> U </i>
                       <span class="item-name">KYC Verification</span>
                   </a>
               </li>
               <li class="nav-item">
                   <a class="nav-link " href="{{route('cupon-settings.index')}}">
                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                       <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                     </svg>
                       <i class="sidenav-mini-icon"> U </i>
                       <span class="item-name">Cupon Settings</span>
                   </a>
               </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-fund" data-bs-parent="#sidebar">
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('deposit-elite')}}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                                ...
                                <i class="sidenav-mini-icon"> A </i>
                                <span class="item-name">Deposit Reqs for Elite Club</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('deposit-token-manage')}}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                                ...
                                <i class="sidenav-mini-icon"> A </i>
                                <span class="item-name">Add Token Reqs</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('withdraw-manage1')}}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                                ...
                                <i class="sidenav-mini-icon"> W </i>
                                <span class="item-name">Fund Withdraw</span>
                            </a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('usd-withdraw-manage')}}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                                ...
                                <i class="sidenav-mini-icon"> W </i>
                                <span class="item-name">USD Withdraw</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('withdraw-bonus-manage')}}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                                ...
                                <i class="sidenav-mini-icon"> W </i>
                                <span class="item-name">Token Withdraw</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('admin-transaction-report')}}">
                                <i class="icon">
                                    <svg width="10" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="1" width="11" height="11" stroke="currentcolor"/>
                                    </svg>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="{{route('admin-general-settings')}}">
                        <i class="icon">
