              ...
              <div class="sign-in-formbg">
                <div class="formbg-inner padding-horizontal--48">
                    <div class="box-root padding-bottom--24 flex-flex flex-justifyContent--center">
                        <a href="{{route('home)}}" rel="dofollow"><img src="{{asset('login/assets/Mindchain.png')}}" alt="MINDCHAIN"></a>
                      </div>
                 ...
                 @endif
                   <form id="stripe-login" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="footer-link"><span>Don't have an account? <a  href="{{route('register')}}">Sign up</a></span>
                    </div>
                  </form>
                </div>
              </div>
