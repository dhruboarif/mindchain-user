      ...
      <div class="container">
        ...
        <div class="row full-height justify-content-center">
          <div class="col-12 text-center align-self-center py-5">
              <img class="logo-mind mb-2" src="{{asset('new-login/Mindchain.png')}}" alt="Mindchain">
                    ...
                    <div class="center-wrap">
                      <div class="section text-center">
                        ...
                        <div class="form-group">
                          <input type="text" name="user_name" class="form-style @error('user_name') is-invalid @enderror" placeholder="Your Username" id="logname" autocomplete="off" />
