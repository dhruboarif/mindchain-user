<div class="modal fade text-left" id="withdrawbonus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel17">Withdraw MIND</h4>
                  ...
                  <div class="row">
                      <div class="col-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="{{$withdraw_commission->min_token_withdraw}}" max="{{$withdraw_commission->max_token_withdraw}}" class="form-control" name="amount" id="amount" placeholder="Enter Amount" aria-describedby="emailHelp" required min="1" max="5000" pattern="[0-9]*">
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <h6>Withdraw limit MIND( >= {{$withdraw_commission->min_token_withdraw}} & <= {{$withdraw_commission->max_token_withdraw}})</h6>
                        </div>
                              </div>
                          </div>
                      </div>
