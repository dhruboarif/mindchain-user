<div class="modal withdraw-modal fade" id="mindtransferconfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="{{route('send-bonus-confirmation')}}">
                @csrf
