<div class="modal fade text-left" id="depositusdt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                  ...
                  <div class="row">
                      <div class="col-12">
                        ...
                        <div class="mb-3">
                          ...
                          <?php
                          $account_info= App\Models\AccountInfo::where('payment_type_id','=',5)->get();
                      ...
                      <!--</select>-->
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Wallet Address (TRC20)</label>

                            <input type="text" name="wallet_id" disabled id="wallet_id" value="{{$payment->wallet_no}}" class="form-control"required/>
                        </div>
                         <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Amount($)</label>
                            <input type="round" class="form-control" name="amount" placeholder="Enter Amount" id="exampleInputEmail1" aria-describedby="emailHelp" required pattern="[0-9]*" min="15" max="5000">
