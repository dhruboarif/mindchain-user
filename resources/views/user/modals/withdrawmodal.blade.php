    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel17">Withdraw MUSD</h4>
              ...
              <section id="multiple-column-form">
                  <div class="row">
                      <div class="col-12">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Amount (MUSD)</label>
                            <input type="round" min="{{$withdraw_commission->withdraw_limit_min}}" max="{{$withdraw_commission->withdraw_limit_max}}" class="form-control" name="amount" placeholder="Enter Amount" id="exampleInputEmail1" aria-describedby="emailHelp" required pattern="[0-9]*">
                        ...
                        <div class="mb-3">
                          ...
                          <h6>Withdraw limit $( >= {{$withdraw_commission->withdraw_limit_min}} & <= {{$withdraw_commission->withdraw_limit_max}})</h6>
                        </div>
                              </div>
                          </div>
                      </div>
