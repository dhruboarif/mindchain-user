<div class="modal fade text-left" id="fundtransferconfirmation{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              ...
                              <form id="test" method="post" action="javascript:void(0)">
                                @csrf
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" id="confirmFundTransfer">Discard</button>
            </div>
              </form>
        </div>
    </div>
