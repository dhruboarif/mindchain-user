...
<div class="header-advance-area">
            <div class="header-top-area">
                <div class="container-fluid">
                    <div class="row">
                        <!-- mobile screen bottom menu start
		============================================ -->
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="mobile-screen-show">
                                <div class="bottom-appbar">
                                    <a href="" class="active">
                                        <svg class="icon-wrap" width="20" height="17" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="header-top-wraper">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="header-top-menu text-light">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                        <div class="header-right-info">
                                            <div class="logo-pro">
                                                <a href=""><img src="{{asset('assetsnew/img/logo/logo.png')}}" class="main-logo" alt="main-logo" /></a>
                                            </div>
                                                <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                    ...
                                                    <li class="nav-item">
                                                        ...
                                                        <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                            ...
                                                            <li><a href="/home/user-payment-method/{{Auth::user()->id}}"><span class="icon nalika-user author-log-ic"></span> Payment Settings</a>
                                                            </li>
