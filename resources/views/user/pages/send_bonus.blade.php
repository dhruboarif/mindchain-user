                ...
                <div class="admin-content res-mg-t-15 d-flex row justify-content-between">
                    ...
                    <div class="row page-top-section">
                        ...
                        <div class="col-sm-6 breadcome-heading">
                            <h3>Mind Transfer History</h3>
                        </div>
                        <div class="col-sm-6">
                            <div class=" breadcome-price-section">
                                <p class="breadcome-section-name">Available Mind:</p>
                    ...
                    <div class="row page-section-btn">
                        <div class="col-sm-12">
                            <button type="button" data-toggle="modal" data-target="#sendmind" data-whatever=""
                                class="page-button">Send Mind</button>
                            <div class="modal withdraw-modal fade" id="sendmind" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Transfer MIND </h5>
                                        ...
                                        <div class="modal-body">
                                            <form id="fundTransferForm" method="post"
                                                ...
                                                <div class="form-group">
                                                    <label for="usdt-amount-deposit" class="col-form-label">Coin Transfer
                                                        to</label>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($row->status == 'pending')
                                                                <a data-toggle="modal"
                                                                    data-target="#mindtransferconfirmation"
                                                                    data-id="{{ $row->id }}"
