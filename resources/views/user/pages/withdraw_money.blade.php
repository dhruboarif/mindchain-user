     ...
     @endif
                ...
                $payment_method= App\Models\UserPayment::where('user_id',Auth::user()->id)->get();
                           ...
                           ?>
                                                ...
                                                <select class="form-select form-control" id="DestinationOptions" name="payment_method_id"  aria-label="Default select example" required onchange="UsdtDepositWalletMenu()">
                        ...
                        @endforeach
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" name="wallet_id" id="wallet_id" readonly>
                                                    ...
                                                    <tr>
                                                       <td >{{$loop->index+1}}</td>
                                                        ...
                                                        <td>{{$row->amount}}</td>
                                                         ...
                                                         <a data-toggle="modal" data-target="#withdrawMusdConfirmation{{$row->id}}" class="btn btn-danger">Confirm Withdraw</a>
                                                         @elseif($row->status == 'pending')
                                                         <a data-toggle="modal" data-target="#withdrawMUsdCancel{{$row->id}}" class="btn btn-danger">Cancel</a>
                                                         @else
                                                        Cancelled
                                                     @endif</td>
