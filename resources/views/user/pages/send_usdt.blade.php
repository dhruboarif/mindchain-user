   ...
   <div class="bd-example">
     ...
     @endif
                    ...
                    <div class="card-body">
                      ...
                      @else
                        <h4 class="card-title">History of Send USDT</h4>
                         @if(Auth::user()->status == 0)
                         <button disabled  type="button" class="btn btn-primary float-right">SEND MIND</button>
                         
                         @else
                        <a class="btn btn-primary float-right" href="#" data-bs-toggle="modal" data-bs-target="#sendusdt">SEND USDT</a>
                        @include('user.modals.sendusdtmodal')
                        @endif
                        <hr>
                        <h6>Available Balance: {{$data['sum_deposit'] ? number_format((float)$data['sum_deposit'], 2, '.', ''). ' USDT' : '00.00 USDT'}}</h6>
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              ...
                              <form id="coinTransferConfirm" method="post" action="{{route('usdt-send-confirmation')}}">
                                @csrf
