                      ...
                      <div class="card-body">
                        ...
                        <input disabled type="text" class="form-control" style="color:#D98019; font-weight:100%;" value="{{$row->package_name}}" >
                            ...
                            <input disabled type="text" class="form-control" value="{{$row->package_price}}" >
                              ...
                              <div class="input-group mb-3">
                              <span class="input-group-text text-right" style="color:#D98019; width: 70%; font-weight:100%;" id="basic-addon1">Coin
                                                                  Amount</span>
                              <input disabled type="text" class="form-control" value="{{$row->amount}}" >
                                ...
                                <input disabled type="text" class="form-control" value="{{$row->duration}}" >
                                  ...
                                  <div class="input-group mb-3">
                                  <span class="input-group-text text-right" style="color:#D98019; width: 70%; font-weight:100%;" id="basic-addon1">Farming Coin
                                                                                      Bonus (%)</span>
                                  <input disabled type="text" class="form-control" value="{{$row->daily_buyer_token}}" >
                                    ...
                                    <div class="text-center">
                                            ...
                                            <button disabled type="submit" class="btn btn-primary">Buy Package</button>
                                            @else
                                          <button type="button" disabled class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#packagebuymodal{{$row->id}}">Buy Package</button>
                                          @include('user.modals.packagebuymodal')
                                          @endif
                                        </form>
                                    </div>
