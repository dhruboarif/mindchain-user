                             ...
                             <table border="0" width="100%" class="table table-active">
                                 <div class="form-group">
                                    ...
                                    @if(Auth::user()->image == null)
                                     ...
                                     <img class="float-right" id="image_upload_preview" src="https://my.mindchainwallet.com/images/ambassador.png" style="border-radius: 10%;" width="150" height="150">
                                     @endif
                                     
                                      @if(Auth::user()->consultant == 2)
                                     <img class="float-right" id="image_upload_preview" src="https://my.mindchainwallet.com/images/CONSULTANT-01.png" style="border-radius: 10%;" width="150" height="150">
                                    @endif
                                     @if(Auth::user()->elite_club == 1)
                                     <img class="float-right" id="image_upload_preview" src="https://my.mindchainwallet.com/images/ELITE MEMBER-01.png" style="border-radius: 10%;" width="150" height="150">
                                     @endif
                                    @if(Auth::user()->ambassador == 1)
                                     <img class="float-right" id="image_upload_preview" src="https://my.mindchainwallet.com/images/ambassador.png" style="border-radius: 10%;" width="150" height="150">
                                     @endif
                                 ...
                                 <tr>
                                      <tr>
                                     <td>NID/Passport Number</td><td> : </td> <td>{{Auth::user()->nid_passport}}</td>
                                 <tr>
