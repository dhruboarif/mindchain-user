                                       ...
                                       <form id="stakingForm" class="col-lg-12" method="post" action="{{route('buy-staking')}}">
                                          ...
                                          <input type="hidden" name="user_id" value="{{Auth::user()->id}}">
                                           ...
                                           <div class="form-group">
                                               ...
                                               <input type="text" class="form-control" id="availableBalance" readonly value="{{$data['sum_deposit_bonus'] ? number_format((float)$data['sum_deposit_bonus'], 2, '.', ''). ' MIND' : '00.00 MIND'}}">
                                           </div>
                                           <div class="form-group">
