     ...
     @endif
                    ...
                    <div class="card-body">
                        <h4 class="card-title">We accept only MIND20</h4>
                         ...
                         <!--<a class="btn btn-primary float-right disabled" href="#" data-bs-toggle="modal" data-bs-target="#addfund">Pay Automatically</a>-->
                        <a class="btn btn-primary float-right disabled" href="#" data-bs-toggle="modal" data-bs-target="#addfund2">Pay Manually</a>
                        @else
